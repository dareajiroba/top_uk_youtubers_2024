...
ORDER BY
    net_profit DESC
```
![Youtubers-with-the-most-videos-uploaded](assets/images/youtubers_with_the_most_videos.png)
...
ORDER BY
    net_profit DESC
```
![Youtubers-with-the-most-views](assets/images/youtubers_with_the_most_views.png)
